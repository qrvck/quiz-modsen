...
export const SUBTITLE_TEXT = `Test your knowledge, challenge your friends, and learn new things. Navigate using the sidebar to start a game, view statistics, or learn more about us.`;
export const START_BUTTON_TEXT = 'Start a New Quiz';
